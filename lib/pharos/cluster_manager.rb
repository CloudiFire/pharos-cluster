...
module Pharos
  class ClusterManager
    ...
    def gather_facts
      ...
      apply_phase(Phases::ConfigureClient, [sorted_master_hosts.first], master: sorted_master_hosts.first, optional: true)
    end
    ...
    def validate
      ...
      apply_phase(Phases::ValidateVersion, [master], master: master)
    end
    ...
    def apply_phases
      ...
      apply_phase(Phases::LabelNode, config.hosts, master: master_hosts.first)
